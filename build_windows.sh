...
$COMPILER -std=c++17 -Iinclude -I/mingw64/include src/main.cpp -o build/windows/Template.exe -L/mingw64/lib -lfltk -lgdi32 -lcomdlg32 -lcomctl32 -lole32 -luuid -lws2_32 -lkernel32 -luser32 -lgdiplus -lshell32 -lwinspool -ladvapi32 -static -static-libgcc -static-libstdc++
