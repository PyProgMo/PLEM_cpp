...
$COMPILER -std=c++17 -Iinclude -I/mingw64/include src/main.cpp -o build/windows/Template.exe -mwindows -L/mingw64/lib -lfltk_images -lpng -lz -lfltk -lgdi32 -lcomdlg32 -lcomctl32 -lole32 -luuid -lws2_32 -lkernel32 -luser32 -lgdiplus -lshell32 -lwinspool -ladvapi32 -static-libgcc
